...
export async function createReservation(locale: Locale, formData: FormData) {
  ...
  const { data: reservationId, error } = await supabase.rpc("create_reservation_with_shares", {
...
export async function updateReservation(reservationId: string, locale: Locale, formData: FormData) {
