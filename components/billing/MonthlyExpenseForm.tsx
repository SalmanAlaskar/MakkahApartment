...
export function MonthlyExpenseForm({
  ...
  return (
    <form action={formAction} className="space-y-4 rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
      ...
      <button
        type="submit"
        disabled={isPending}
        className="w-full rounded-md bg-sky-600 px-4 py-2.5 text-base font-medium text-white transition-colors hover:bg-sky-700 disabled:opacity-60"
      >
